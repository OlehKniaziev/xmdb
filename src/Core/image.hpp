...
constexpr UZ MAX_DISK_IMAGE_CHUNK_DATA_SIZE =
        MAX_DISK_IMAGE_CHUNK_SIZE - sizeof(DiskImageChunk);
constexpr UZ MAX_DISK_IMAGE_CHUNKS_COUNT =
        MAX_DISK_IMAGE_SIZE / MAX_DISK_IMAGE_CHUNK_SIZE;
constexpr UZ MAX_IMAGE_DATA_SIZE =
        MAX_DISK_IMAGE_CHUNK_DATA_SIZE * MAX_DISK_IMAGE_CHUNKS_COUNT;
